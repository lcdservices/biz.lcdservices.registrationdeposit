 ...
 *
 */
class CRM_registrationdeposit_Event_StateMachine_Registration extends CRM_Core_StateMachine {
  ...
  public function __construct($controller, $action = CRM_Core_Action::NONE) {
    ...
    $additionalPages = array(
      'CRM_registrationdeposit_Event_Form_Registration_Confirm' => NULL,
    ...
    if (!$is_confirm_enabled && !$is_monetary) {
      unset($pages['CRM_registrationdeposit_Event_Form_Registration_Confirm']);
    }
